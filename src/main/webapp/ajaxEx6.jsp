...
<script>
	$(document).ready(function() {
		...
		$("#btn-7").click(function () {
			$.get("/replies/64").done(function(data) {
				console.log(data);
			});
		});
		
		$("#btn-8").click(function () {
			$.get("/replies/64", function(data) {
				console.log(data);
			});
		});
		...
		$("#btn-11").click(function () {
			$.getJSON("/replies/64", function(data) {
				console.log(data);
				console.log(data.rno);
				console.log(data.bno);
				console.log(data.reply);
...
<div>
	<button id="btn-8">댓글 조회2</button>
</div>
<div>
	<button id="btn-9">댓글 조회3</button>
</div>
<div>
	<button id="btn-10">댓글 조회4</button>
</div>
<div>
	<button id="btn-11">댓글 조회5</button>
</div>
</body>
</html>